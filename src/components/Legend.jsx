...
export default function Legend({ scaleCount }) {
    ...
    return (
        <div className="flex flex-wrap justify-center gap-x-5 gap-y-3 mt-6 text-sm font-medium text-slate-600 bg-slate-50 p-3 rounded-lg max-w-4xl mx-auto border border-slate-100">
            ...
            {has3 && <div className="flex items-center gap-2"><div className="w-4 h-4 rounded-full bg-orange-300 border border-orange-500"></div> Csak 3. Skála</div>}

            {/* Közös hangok — gradient a két skála színéből */}
            ...
            {has3 && <>
                <div className="flex items-center gap-2">
                    <div className="w-4 h-4 rounded-full bg-gradient-to-r from-teal-300 to-orange-300 border border-teal-400"></div>
                    1+3 Közös
                </div>
                <div className="flex items-center gap-2">
                    <div className="w-4 h-4 rounded-full bg-gradient-to-r from-purple-300 to-orange-300 border border-purple-400"></div>
                    2+3 Közös
                </div>
                <div className="flex items-center gap-2">
                    <div className="w-4 h-4 rounded-full bg-gradient-to-r from-teal-300 via-purple-300 to-orange-300 border border-purple-400"></div>
                    Mindhárom közös
                </div>
            </>}
